...
class MoveFilesApp:
    ...
    def select_config_file(self):
        ...
        file_path = filedialog.askopenfilename(title="Seleccionar archivo de configuración", filetypes=[("Archivos de texto", "*.txt")])
        if file_path:
    ...
    def copy_files(self, selected_device, source, destination):
        ...
        if source.startswith("./"):
            ...
            source_path = os.path.join(os.path.dirname(__file__), source[2:])
