                ...
                try:
                    if accion == 'copiar':
                        ...
                        if os.path.isdir(origen):
                            self.copiar_carpeta(origen, destino)

                            # Reemplazar archivos existentes en destino
                            ...
                            acciones_completadas.append(f'Se copió la carpeta {origen} a {destino}')
                        else:
                            self.copiar_archivo(origen, destino)
                            acciones_completadas.append(f'Se copió el archivo {origen} a {destino}')
